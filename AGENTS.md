# Geography and the Environment Pupil's Book Standard 4 — ADT Bundle Reference
...
**Geography and the Environment Pupil's Book Standard 4** — This appears to be an English-language primary school textbook titled Geography and the Environment for Standard 4, so it is aimed at roughly lower-primary learners, around ages 9–10. From the visible material, it introduces basic geography skills such as reading simple maps, using keys and understanding scale and distance, with an environmental studies focus. The use of “Standard 4” and the school example “Mbuga Primary School” suggests an East African origin, likely Tanzania or a neighbouring country. Its approach seems practical and activity-based, using diagrams, measurements and local examples to build foundational geographical understanding.
...
```
GEOGRAPHY-AND-THE-ENVIRONMENT-STD-4-17-09-2025/
├── adt/                              # THE WEB APP
...
├── GEOGRAPHY-AND-THE-ENVIRONMENT-STD-4-17-09-2025.db                    # SQLite database (pipeline state)
├── GEOGRAPHY-AND-THE-ENVIRONMENT-STD-4-17-09-2025.pdf                   # Original source PDF
...
| `pg{NNN}_im{NNN}` | Image alt text / description | `pg001_im030` |
...
{
  "pg001_gp001_tx001": "",
  "pg001_im030": "Certificate of Approval from the United Republic of Tanzania Ministry of Education, Science and Technology for ‘Geography and the Environment Pupil’s Book, Standard Four’, approved on 11 September 2024; certificate no. 1624, signed by the Commissioner for Education, Dr Lyabwene M. Mtababwa.",
  "gl001": "accurately",
  "gl001_def": "in a careful and correct way, without mistakes",
  "qz001_que": "What is a map?",
  "qz001_o0": "1) A drawing of the earth’s surface",
  "qz001_o0_exp": "✅ Correct! A map is a drawing that shows information about places on the earth’s surface using a scale."
}
```
...
```json
{
  "accurately": {
    "word": "accurately",
    "definition": "in a careful and correct way, without mistakes",
    "variations": ["accurately","accurate"],
    "emoji": "✅🎯"
  }
}
```
...
```json
{
  "title": "Geography and the Environment Pupil's Book Standard 4",
  "bundleVersion": "1",
  "languages": {
    "available": [
      "en-GB"
...
<body>
    <div id="content" class="opacity-0">
        <section role="article" data-section-type="text_and_single_image"
            ...
            <img data-id="pg001_im030" src="images/pg001_im030.png" ...>
...
<section role="activity" data-section-type="activity_quiz" data-id="qz001"
    ...
    <p data-id="qz001_que">What is a map?</p>

    <label data-activity-item="qz001_o0"
           data-explanation="✅ Correct! A map is a drawing that shows information about places on the earth’s surface using a scale." data-explanation-id="qz001_o0_exp">
        <input type="radio" name="qz001" value="qz001_o0" class="sr-only" />
        <span data-id="qz001_o0">1) A drawing of the earth’s surface</span>
    </label>
    <!-- more options... -->
</section>
...
| Original PDF | `GEOGRAPHY-AND-THE-ENVIRONMENT-STD-4-17-09-2025.pdf` |
| Pipeline database | `GEOGRAPHY-AND-THE-ENVIRONMENT-STD-4-17-09-2025.db` (SQLite) |
